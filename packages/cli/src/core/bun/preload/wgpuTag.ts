...
import "./globals.d.ts";
import { request, send } from "./internalRpc";
...
export class ElectrobunWgpuTag extends HTMLElement {
  ...
  toggleTransparent(value?: boolean) {
    ...
    this.transparent = value === undefined ? !this.transparent : value;
  ...
  togglePassthrough(value?: boolean) {
    ...
    this.passthroughEnabled =
      value === undefined ? !this.passthroughEnabled : value;
  ...
  toggleHidden(value?: boolean) {
    ...
    this.hidden = value === undefined ? !this.hidden : value;
