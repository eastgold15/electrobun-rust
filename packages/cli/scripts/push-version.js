...
// repoRoot 是 git 仓库根目录（从 packages/cli 向上两级）
...
const kitchenConfigPath = join(repoRoot, "apps", "kitchen", "electrobun.config.ts");
...
execSync(`git add packages/cli/package.json apps/kitchen/electrobun.config.ts`, {
	cwd: repoRoot,
	stdio: "inherit",
});
