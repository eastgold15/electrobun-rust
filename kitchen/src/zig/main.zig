...
const zig_tests = [_]ZigTest{
    ...
    .{
        ...
        .category = "BrowserWindow",
        .description = "Set and read the primary BrowserWindow page zoom inRust mode.",
    ...
    .{
        ...
        .category = "BrowserWindow",
        .description = "Toggle fullscreen for a hidden-titlebar window inRust mode on macOS.",
    ...
    .{
        ...
        .category = "BrowserWindow",
        .description = "Toggle visible-on-all-workspaces inRust mode on macOS.",
    ...
    .{
        ...
        .category = "BrowserWindow",
        .description = "Verify a per-window close callback fires inRust mode.",
    ...
    .{
        ...
        .category = "BrowserWindow",
        .description = "Verify a per-window resize callback fires inRust mode.",
    ...
    .{
        ...
        .category = "BrowserWindow",
        .description = "Create a native window with hiddenInset titlebar style inRust mode.",
    ...
    .{
        ...
        .category = "BrowserWindow",
        .description = "Set and read BrowserView page zoom inRust mode.",
    ...
    .{
        ...
        .category = "WGPU Tag",
        .description = "Load the real WGPU tag playground inRust mode and verify electrobun-wgpu initializes through the Zig host bridge.",
    ...
    .{
        ...
        .name = "loadURL (Zig)",
        .category = "Navigation",
        .description = "Load a new internal URL into a BrowserView inRust mode.",
    ...
    .{
        ...
        .name = "loadHTML (Zig)",
        .category = "Navigation",
        .description = "Load inline HTML into a BrowserView inRust mode.",
    ...
    .{
        ...
        .category = "Navigation",
        .description = "Verify dom-ready is emitted for BrowserView navigation inRust mode.",
    ...
    .{
        ...
        .category = "Navigation",
        .description = "Verify did-navigate is emitted for BrowserView navigation inRust mode.",
    ...
    .{
        ...
        .category = "Tray",
        .description = "Create a tray item, toggle visibility, and read bounds inRust mode.",
    ...
    .{
        ...
        .description = "Open the real application-menu playground inRust mode and keep it open for manual interaction.",
        .interactive = true,
    ...
    .{
        ...
        .category = "Menus (Interactive)",
        .description = "Open the real context-menu playground inRust mode and keep it open for manual interaction.",
        .interactive = true,
    ...
    .{
        ...
        .category = "Dialogs (Interactive)",
        .description = "Open the real file-dialog playground inRust mode and keep it open for manual interaction.",
        .interactive = true,
    ...
    .{
        ...
        .description = "Open the real shortcuts playground inRust mode and keep it open for manual interaction.",
        .interactive = true,
    ...
    .{
        ...
        .description = "Open the real quit-test playground inRust mode and keep it open for manual interaction.",
        .interactive = true,
    ...
    .{
        ...
        .category = "Screen",
        .description = "Verify primary display workArea fits within bounds inRust mode.",
    ...
    if (webview_id != 0) {
        sendRpcMessage(webview_id, "beforeQuitDone", .{
            .message = if (beforeQuitShouldCancel())
                "beforeQuit cleanup complete (2s elapsed). Quit cancelled inRust mode."
            else
