...
mod tests {
    ...
    fn test_encrypt_decrypt() {
        ...
        let ciphertext = encrypt_message(&key, &nonce, plaintext).expect("test encryption should succeed");
        let decrypted = decrypt_message(&key, &nonce, &ciphertext).expect("test decryption should succeed");
