...
const WGPUCallbackMode_AllowSpontaneous = 0x00_00_00_03;
const WGPUTextureFormat_BGRA8Unorm = 0x00_00_00_1b;
const WGPUTextureFormat_BGRA8UnormSrgb = 0x00_00_00_1c;
const WGPUTextureFormat_RGBA8UnormSrgb = 0x00_00_00_17;
...
const WGPUVertexFormat_Float32 = 0x00_00_00_1c;
const WGPUVertexFormat_Float32x2 = 0x00_00_00_1d;
const WGPUVertexFormat_Float32x3 = 0x00_00_00_1e;
const WGPUVertexStepMode_Vertex = 0x00_00_00_01;
const WGPUPrimitiveTopology_TriangleList = 0x00_00_00_04;
const WGPUFrontFace_CCW = 0x00_00_00_01;
const WGPUCullMode_None = 0x00_00_00_01;
const WGPUCullMode_Back = 0x00_00_00_03;
const WGPUPresentMode_Fifo = 0x00_00_00_01;
const WGPUCompositeAlphaMode_Auto = 0x00_00_00_00;
const WGPUCompositeAlphaMode_Opaque = 0x00_00_00_01;
const WGPUCompositeAlphaMode_Premultiplied = 0x00_00_00_02;
const WGPUCompositeAlphaMode_Unpremultiplied = 0x00_00_00_03;
const WGPULoadOp_Clear = 0x00_00_00_02;
const WGPUStoreOp_Store = 0x00_00_00_01;
const WGPU_STRLEN = 0xffffffffffffffffn;
const WGPU_DEPTH_SLICE_UNDEFINED = 0xff_ff_ff_ff;
const WGPUTextureAspect_All = 0x00_00_00_01;
const WGPUTextureDimension_2D = 0x00_00_00_02;
const WGPUAddressMode_ClampToEdge = 0x00_00_00_01;
const WGPUFilterMode_Linear = 0x00_00_00_02;
const WGPUMipmapFilterMode_Linear = 0x00_00_00_02;
...
function makeMultisampleState() {
  ...
  writePtr(view, 0, 0);
  writeU32(view, 8, 1);
  writeU32(view, 12, 0xff_ff_ff_ff);
  writeU32(view, 16, 0);
  writeU32(view, 20, 0);
  return { buffer, ptr: ptr(buffer) };
}
      ...
      await new Promise<void>((resolve, reject) => {
        ...
        const start = async () => {
          ...
          const mesh = new three.Mesh(
            geometry,
            new three.MeshBasicMaterial({ color: 0x00_ff_88 })
          );
...
fn fs_main(
  ...
  return vec4<f32>(color, 1.0);
          ...
          new Uint8Array(attrBuf, 128, 32).set(
            new Uint8Array(colorAttr.buffer)
          );
          ...
          const autoRunThree =
            process.env["AUTO_RUN_TEST_NAME"] === "Three.js WGPU playground";
...
fn fs_main(
  ...
  return vec4<f32>(col, alpha);
            ...
            const posAttr = makeVertexAttribute(
              0,
              0,
              WGPUVertexFormat_Float32x2
            );
            const timeAttr = makeVertexAttribute(
              8,
              1,
              WGPUVertexFormat_Float32
            );
            const resAttr = makeVertexAttribute(
              12,
              2,
              WGPUVertexFormat_Float32x2
            );
            ...
            new Uint8Array(attrBuf, 0, 32).set(new Uint8Array(posAttr.buffer));
            new Uint8Array(attrBuf, 32, 32).set(
              new Uint8Array(timeAttr.buffer)
            );
            ...
            const renderFrame = () => {
              ...
              if (!texPtr) {
                if (frameCount === 0) {
                  log("WGPU: surface texture is null");
                }
                return;
              }
              ...
              if (!commandBuffer) {
                if (frameCount === 0) {
                  log("WGPU: commandBuffer is null");
                }
                return;
              }
              const commandArray = makeCommandBufferArray(commandBuffer);
  ...
  defineTest({
    ...
    category: "WGPUView (Interactive)",
    description:
      "Render a rotating cube in a transparent window (DComp compositing test)",
    interactive: true,
    timeout: 120_000,
    async run({ log, showInstructions }) {
      await showInstructions([
